    ...
    <div className="min-h-screen bg-[#0a0d14] text-slate-100 flex items-center justify-center p-6 selection:bg-cyan-500 selection:text-slate-950">
      <div className="w-full max-w-md bg-slate-900/60 border border-slate-800/80 rounded-2xl p-8 backdrop-blur-md shadow-2xl">
        ...
        <div className="text-center mb-8">
          ...
          <h2 className="mt-4 text-2xl font-bold text-white">Join Vectra AI</h2>
          <p className="text-sm text-slate-400 mt-1">Start trading with $10,000 demo capital</p>
        </div>
        ...
        <form className="space-y-4">
          ...
          <div className="flex items-center gap-2 pt-2">
            <input type="checkbox" id="terms" className="rounded bg-slate-950 border-slate-800 text-cyan-500 focus:ring-0" />
            <label htmlFor="terms" className="text-xs text-slate-400">
              I agree to Risk Guidelines & $10 live cap policy
            </label>
          </div>
